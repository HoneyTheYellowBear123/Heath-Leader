...
VALUES	('UNIT_LEHEATHEL_CROSSBOWMAN', 'LOC_UNIT_LEHEATHEL_CROSSBOWMAN_NAME', 'LOC_UNIT_LEHEATHEL_CROSSBOWMAN_DESCRIPTION', 'DOMAIN_LAND', 'FORMATION_CLASS_LAND_COMBAT', 'PROMOTION_CLASS_RANGED',     3,              3,          30,     45,             3,      0,              3,              'YIELD_GOLD',   0,              180,    'NO_COST_PROGRESSION',  0,                      'TRAIT_HEATH_UNIT_LEHEATHEL_CROSSBOWMAN',            'TECH_MACHINERY',       'TECH_ADVANCED_BALLISTICS',       'ADVISOR_CONQUEST' );
...
VALUES	
		...
		('TRAIT_HEATH_UNIT_LEHEATHEL_CROSSBOWMAN',						'CIVILIZATION_JOEL_CIV_SHOSHONE');

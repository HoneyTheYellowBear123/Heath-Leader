...
VALUES	
		...
		('CIVILIZATION_JOEL_CIV_SHOSHONE',		'LEADER_JOEL_SACAGAWEA_SHOSHONE',	'TRAIT_CIVILIZATION_DISTRICT_SOLSTICE_CENTER',					'ICON_UNIT_INDIAN_SPEAR',		'LOC_DISTRICT_SOLSTICE_CENTER_NAME',						'LOC_DISTRICT_SOLSTICE_CENTER_DESCRIPTION',			30);
...
VALUES
		...
		('Players:Expansion1_Players',		'CIVILIZATION_JOEL_CIV_SHOSHONE',		'LEADER_JOEL_SACAGAWEA_SHOSHONE',	'TRAIT_CIVILIZATION_DISTRICT_SOLSTICE_CENTER',					'ICON_UNIT_INDIAN_SPEAR',		'LOC_DISTRICT_SOLSTICE_CENTER_NAME',						'LOC_DISTRICT_SOLSTICE_CENTER_DESCRIPTION',			30),
		...
		('Players:Expansion2_Players',		'CIVILIZATION_JOEL_CIV_SHOSHONE',		'LEADER_JOEL_SACAGAWEA_SHOSHONE',	'TRAIT_CIVILIZATION_DISTRICT_SOLSTICE_CENTER',					'ICON_UNIT_INDIAN_SPEAR',		'LOC_DISTRICT_SOLSTICE_CENTER_NAME',						'LOC_DISTRICT_SOLSTICE_CENTER_DESCRIPTION',			30);

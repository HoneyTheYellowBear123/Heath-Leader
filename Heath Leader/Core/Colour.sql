...
INSERT INTO Colors 
		(Type, 															Color)
VALUES	('COLOR_PLAYER_JOEL_CIV_SHOSHONE_LEADER_SACAGAWEA_A_PRIMARY',	'255,		110,	199,	255'),
		('COLOR_PLAYER_JOEL_CIV_SHOSHONE_LEADER_SACAGAWEA_A_SECONDARY', 	'0,0,0,	255'),
		('COLOR_PLAYER_JOEL_CIV_SHOSHONE_LEADER_SACAGAWEA_B_PRIMARY',	'0,		0,		0,	255'),
		('COLOR_PLAYER_JOEL_CIV_SHOSHONE_LEADER_SACAGAWEA_B_SECONDARY', 	'255,		110,	199		255'),
